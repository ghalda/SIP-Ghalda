                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input @error('role_id') is-invalid @enderror" type="radio" id="role_id" name="role_id" value="adm">
                                        <label for="role_id" class="form-check-label">
                                            Admin
                                        </label>
                                        <br>
                                        <input class="form-check-input @error('role_id') is-invalid @enderror" type="radio" id="role_id" name="role_id" value="usr">
                                        <label for="role_id" class="form-check-label">
                                            User
                                        </label>
                                        @error('role_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter E-mail" name="email" value="{{old('email')}}">
                                    @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
